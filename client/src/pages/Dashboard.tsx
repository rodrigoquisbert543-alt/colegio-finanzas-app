  ...
  return (
    <div className="container">
      <div className="page-header" style={{ marginBottom: '2.5rem' }}>
        <div>
          ...
          <p className="page-subtitle">
            {filters.userId ? `Caja activa de: ${cashiers.find(c => c.id.toString() === filters.userId.toString())?.name || user.name}` : 'Consolidado General (Todas las Cajas)'}
          </p>
        </div>
      </div>
      ...
      <div className="dashboard-grid" style={{ marginBottom: '2rem' }}>
        <div className="card" style={{ borderLeft: '6px solid var(--success)', background: 'linear-gradient(135deg, #ffffff 0%, hsl(var(--success-hue), 72%, 99%) 100%)' }}>
        ...
        <div className="card" style={{ borderLeft: '6px solid var(--danger)', background: 'linear-gradient(135deg, #ffffff 0%, hsl(var(--danger-hue), 82%, 99%) 100%)' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start' }}>
            <div>
        ...
        <div className="card" style={{ borderLeft: '6px solid var(--primary)', background: 'linear-gradient(135deg, #ffffff 0%, hsl(var(--primary-hue), 85%, 99%) 100%)' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start' }}>
            <div>
        ...
        <div className="card" style={{ borderLeft: '6px solid #8b5cf6', background: 'linear-gradient(135deg, #ffffff 0%, #f5f3ff 100%)' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start' }}>
            <div>
        ...
        <div className="card">
          ...
          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <svg viewBox="0 0 400 200" width="100%" height="200" style={{ background: 'transparent', overflow: 'visible' }}>
              ...
              {/* Income Bar */}
              <rect x="110" y={180 - incomeHeight} width="45" height={Math.max(incomeHeight, 2)} rx="6" fill="url(#incomeGrad)" style={{ transition: 'all 0.5s ease-out' }} />
              ...
              {/* Expense Bar */}
              <rect x="220" y={180 - expenseHeight} width="45" height={Math.max(expenseHeight, 2)} rx="6" fill="url(#expenseGrad)" style={{ transition: 'all 0.5s ease-out' }} />
              <text x="242.5" y={180 - expenseHeight - 8} fontSize="11" fontWeight="bold" fill="var(--danger)" text-anchor="middle" textAnchor="middle">Bs. {stats.expense_total.toFixed(0)}</text>
      ...
      {/* Cash Register Settlement Count */}
